...
namespace InterfazGrafica.Formularios
{
    public partial class DashBoard : Form
    {
        ...
        private void but_Clientes_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Recuerde seleccionar un cliente de la lista antes de pulsar el botón lista de pedidos", "Selecciones un cliente");
        ...
        {
            if (this.clientes.ClinteSeleccionado != null)
            {
